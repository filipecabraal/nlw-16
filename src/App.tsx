      ...
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <div className='space-y-4'>
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center gap-3 shadow-shape">
            ...
            {isGuestsInputOpen ? (
              <button
                className='bg-zinc-800 text-zinc-200 rounded-lg px-5 py-2 font-medium 
              ...
              <button
                ...
                className='bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium 
          ...
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            <div className='space-y-2'>
              <div className='flex items-center justify-between'>
                ...
                <button type='button' onClick={handleGuestsModalOpen}>
        ...
        <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <form onSubmit={addEmailToInvite} className='space-y-3'>
              ...
              <button
                type='submit'
                className='bg-lime-300 text-lime-950 rounded-lg px-5 h-11 font-medium 
